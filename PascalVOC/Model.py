...
class backbone(nn.Module):
    def __init__(self, in_channels=3, classes=6, k=256, l=256, m=384, n=384):
...
class Neck(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(5984,256,1,stride=1,padding=0,bias=False)
        self.conv2 = nn.Conv2d(11232,512,1,stride=1,padding=0,bias=False)
        self.conv3 = nn.Conv2d(6656,1024,1,stride=1,padding=0,bias=False)
...
class Detect(nn.Module):
    ...
    def __init__(self, num_classes=20, num_layers=3, inplace=True, head_layers=None, use_dfl=False, reg_max=0):
        super().__init__()
...
class Model(nn.Module):
    def __init__(self, num_classes, backbone, channels_list):
        ...
        #pretrained_weights_path = '/raid/cs21resch15003/Afeef_Intern/Backbone_weights'
