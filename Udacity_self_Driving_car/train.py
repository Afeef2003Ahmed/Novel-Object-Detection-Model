...
from Dataset import load_checkpoint,train_loader,save_checkpoint




device = torch.device('cuda:2' if torch.cuda.is_available() else 'cpu:0')
model = Model(num_classes=11,backbone=backbone(),channels_list = [256,512,1024])
