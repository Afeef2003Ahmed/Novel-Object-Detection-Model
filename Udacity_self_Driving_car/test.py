...
from Dataset import load_checkpoint,train_loader


device = 'cuda:1' if torch.cuda.is_available() else 'cpu'
model_test = Model(num_classes=11,backbone=backbone(),channels_list = [256,512,1024])
...
#best_model = torch.load("/raid/cs21resch15003/Afeef_Intern/CustomModel_BDD100K/best_model2.pt")
...
confusion_matrix = ConfusionMatrix(nc=11)
...
save_dir = '/raid/cs21resch15003/Afeef_Intern/CustomModel_Self_DrivingCars/Results'
stats = [np.concatenate(x, 0) for x in zip(*stats)]
names=["car","pedestrian","trafficLight-Red","trafficLight-Green","truck","trafficLight","biker","trafficLight-RedLeft","trafficLight-GreenLeft","trafficLight-Yellow","trafficLight-YellowLeft"]
plot_curve = True
if len(stats) and stats[0].any():
    p, r, ap, f1, ap_class = ap_per_class(*stats, plot=plot_curve, save_dir=save_dir, names=("car","pedestrian","trafficLight-Red","trafficLight-Green","truck","trafficLight","biker","trafficLight-RedLeft","trafficLight-GreenLeft","trafficLight-Yellow","trafficLight-YellowLeft"))
